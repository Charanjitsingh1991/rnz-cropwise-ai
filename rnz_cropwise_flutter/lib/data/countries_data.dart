...
// For user registration/signup, use world_countries.dart (all countries)
...
// Pilot countries data matching the web app exactly
final List<PilotCountry> pilotCountriesData = [
  PilotCountry(
    code: 'IN',
    name: 'India',
    phoneCode: '+91',
  ...
  PilotCountry(
    ...
    states: [
      ...
      PilotLocation(code: 'MU', name: 'Muharraq Governorate', cities: ['Muharraq', 'Arad', 'Al Hidd', 'Al Dair', 'Al Qalali', 'Al Sayh', 'Al Gharafa', 'Al Hilal', 'Al Mamoura', 'Al Sadd']),
      PilotLocation(code: 'SH', name: 'Southern Governorate', cities: ['Riffa', 'Isa Town', 'Sitra', 'Al Dur', 'Al Malikiyah', 'Al Zallaq', 'Al Areen', 'Al Jazayer', 'Al Bar', 'Al Jasra']),
      PilotLocation(code: 'NO', name: 'Northern Governorate', cities: ['Hamad Town', 'Al Budaiya', 'Al Jasra', 'Al Markh', 'Al Qadam', 'Al Hoora', 'Al Noaim', 'Al Mahooz', 'Al Fateh', 'Seef']),
    ],
  ),
  PilotCountry(
    code: 'OM',
...
// Helper functions
PilotCountry? getPilotCountry(String countryCode) {
  try {
...
List<PilotLocation> getStatesByCountry(String countryCode) {
  final country = getPilotCountry(countryCode);
  return country?.states ?? [];
}

List<String> getCitiesByState(String countryCode, String stateCode) {
  final country = getPilotCountry(countryCode);
  if (country == null) return [];
  
  final state = country.states.firstWhere(
    (s) => s.code == stateCode,
    orElse: () => PilotLocation(code: '', name: '', cities: []),
  );
  return state.cities ?? [];
}

// Legacy support - keep the old Country class for backward compatibility
class Country {
  final String name;
  final String code;
  final String phoneCode;
...
// Convert pilot countries to the old format for backward compatibility
const pilotCountries = [
  Country(name: 'India', code: 'IN', phoneCode: '+91', phoneLength: [10], flag: '🇮🇳'),
  Country(name: 'Pakistan', code: 'PK', phoneCode: '+92', phoneLength: [10], flag: '🇵🇰'),
  Country(name: 'Sri Lanka', code: 'LK', phoneCode: '+94', phoneLength: [9], flag: '🇱🇰'),
  Country(name: 'Bangladesh', code: 'BD', phoneCode: '+880', phoneLength: [10], flag: '🇧🇩'),
  Country(name: 'United Arab Emirates', code: 'AE', phoneCode: '+971', phoneLength: [9], flag: '🇦🇪'),
  Country(name: 'Saudi Arabia', code: 'SA', phoneCode: '+966', phoneLength: [9], flag: '🇸🇦'),
  Country(name: 'Kuwait', code: 'KW', phoneCode: '+965', phoneLength: [8], flag: '🇰🇼'),
  Country(name: 'Qatar', code: 'QA', phoneCode: '+974', phoneLength: [8], flag: '🇶🇦'),
  Country(name: 'Bahrain', code: 'BH', phoneCode: '+973', phoneLength: [8], flag: '🇧🇭'),
  Country(name: 'Oman', code: 'OM', phoneCode: '+968', phoneLength: [8], flag: '🇴🇲'),
  // New countries added for expanded pilot program
  Country(name: 'Malaysia', code: 'MY', phoneCode: '+60', phoneLength: [10], flag: '🇲🇾'),
  Country(name: 'South Africa', code: 'ZA', phoneCode: '+27', phoneLength: [9], flag: '🇿🇦'),
  Country(name: 'Kenya', code: 'KE', phoneCode: '+254', phoneLength: [9], flag: '🇰🇪'),
  Country(name: 'Brazil', code: 'BR', phoneCode: '+55', phoneLength: [11], flag: '🇧🇷'),
  Country(name: 'New Zealand', code: 'NZ', phoneCode: '+64', phoneLength: [9], flag: '🇳🇿'),
  Country(name: 'Canada', code: 'CA', phoneCode: '+1', phoneLength: [10], flag: '🇨🇦'),
  Country(name: 'Egypt', code: 'EG', phoneCode: '+20', phoneLength: [10], flag: '🇪🇬'),
  Country(name: 'Cambodia', code: 'KH', phoneCode: '+855', phoneLength: [9], flag: '🇰🇭'),
  Country(name: 'China', code: 'CN', phoneCode: '+86', phoneLength: [11], flag: '🇨🇳'),
];
