...
export const countryCodes: Country[] = [
    ...
    { name: 'Antigua and Barbuda', code: '+1-268', length: 10 },
    ...
    { name: 'Bahamas', code: '+1-242', length: 10 },
    { name: 'Bahrain', code: '+973', length: 8 },
    { name: 'Bangladesh', code: '+880', length: 10 },
    { name: 'Barbados', code: '+1-246', length: 10 },
    ...
    { name: 'Cabo Verde', code: '+238', length: 7 },
    ...
    { name: 'Cote d\'Ivoire', code: '+225', length: 10 },
    ...
    { name: 'Indonesia', code: '+62', length: 11 },
    ...
    { name: 'Papua New Guinea', code: '+675', length: 8 },
    ...
    { name: 'Timor-Leste', code: '+670', length: 8 },
    ...
    { name: 'United States of America', code: '+1', length: 10 },
